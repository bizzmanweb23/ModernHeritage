                                    ...
                                    <select name="country_code_m" class="form-control"  id="country_code_m">
                                        <option value="">--Select--</option>
                                            @foreach($countryCodes as $c)
                                                <option value="+{{ $c->code }}" {{ substr($user->mobile, 0, 3) == $c->code ? 'selected' : '' }}>+{{ $c->code }}({{ $c->name }})</option>
                                            @endforeach
                                    </select>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" name="mobile" id="mobile"
                                            value="{{ substr($user->mobile, 3) }}" placeholder="user Mobile" class="form-control"
                                            required />   
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="display: flex; flex-wrap: no-wrap;" class="edit_input">
                            ...
                            <div class="form-check mr-2">
                                <input class="form-check-input" type="radio" name="user_type" id="customer"
                                    value="customer" {{ $user->user_type == "customer" ? "checked" : ""}}>
                                <label class="form-check-label" for="user_type">
                                    Customer
                                </label>
                            </div>
                            <div class="form-check mr-2">
                                <input class="form-check-input" type="radio" name="user_type" id="others"
                                    value="others" {{ $user->user_type == "others" ? "checked" : ""}}>
                                <label class="form-check-label" for="user_type">
                                    Others
                                </label>
                            </div>
