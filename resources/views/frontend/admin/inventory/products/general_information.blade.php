<div style="padding-top: 1.5rem;">
    ...
    <div class="row mb-2">
        ...
        <div class="col-md-6">
            <span class="mb-2 ">Cost:
                <input type="number" name="cost" id="cost" value="" placeholder="₹" class="form-control" />
            </span>
        </div>
    </div>
    <div class="row mb-2">
    ...
    <div class="row mb-2">
        ...
        <input name="internal_notes" id="internal_notes" class="form-control" placeholder="This note is only for internal purposes">
    </div>
</div>
