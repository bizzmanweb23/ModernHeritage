<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <!-- <li class="nav-item">
          <a class="nav-link  " href="{{ route('getRequest')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Logistic Management</h6>
        </li>
        <li class="nav-item">
        ...
        <!-- <li class="nav-item">
          <a class="nav-link  " href="{{ route('ViewCalander') }}">
            ...
            <span class="nav-link-text ms-1">Logistic Dashboard</span>
          </a>
        </li> -->
        <!-- <li class="nav-item">
          <a class="nav-link  " href="{{ route('ViewCalander1') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>settings</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Logistic Dashboard1</span>
          </a>
        </li> -->
        <!-- <li class="nav-item">
          <a class="nav-link  " href="{{route('Delivery-Orders')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>settings</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              ...
              <li class="nav-item ">
							...
							<a class="nav-link " href="{{ route('deliveries') }}">
									<span class="sidenav-mini-icon"> C </span>
									<span class="sidenav-normal"> Delivery </span>
								</a>
							</li>
